 ...
 * 
 * @deprecated Use DEFAULT_THEME instead. This will be removed after full migration.
 */
export const CONFIG = {
    BASE_PX: {
        W: DEFAULT_THEME.basePx.width,
        H: DEFAULT_THEME.basePx.height
    },
    POS_PX: DEFAULT_POSITIONS,
    FONTS: {
        family: DEFAULT_THEME.fonts.family,
        sizes: DEFAULT_THEME.fonts.sizes
    },
    COLORS: {
        primary_color: DEFAULT_THEME.colors.primary,
        deep_primary: DEFAULT_THEME.colors.deepPrimary,
        text_primary: DEFAULT_THEME.colors.textPrimary,
        text_small_font: DEFAULT_THEME.colors.textSmallFont,
        background_white: DEFAULT_THEME.colors.backgroundWhite,
        card_bg: DEFAULT_THEME.colors.cardBg,
        background_gray: DEFAULT_THEME.colors.backgroundGray,
        faint_gray: DEFAULT_THEME.colors.faintGray,
        ghost_gray: DEFAULT_THEME.colors.ghostGray,
        table_header_bg: DEFAULT_THEME.colors.tableHeaderBg,
        lane_border: DEFAULT_THEME.colors.laneBorder,
        card_border: DEFAULT_THEME.colors.cardBorder,
        neutral_gray: DEFAULT_THEME.colors.neutralGray,
        process_arrow: DEFAULT_THEME.colors.processArrow
    },
    DIAGRAM: {
        laneGap_px: DEFAULT_THEME.diagram.laneGapPx,
        lanePad_px: DEFAULT_THEME.diagram.lanePadPx,
        laneTitle_h_px: DEFAULT_THEME.diagram.laneTitleHeightPx,
        cardGap_px: DEFAULT_THEME.diagram.cardGapPx,
        cardMin_h_px: DEFAULT_THEME.diagram.cardMinHeightPx,
        cardMax_h_px: DEFAULT_THEME.diagram.cardMaxHeightPx,
        arrow_h_px: DEFAULT_THEME.diagram.arrowHeightPx,
        arrowGap_px: DEFAULT_THEME.diagram.arrowGapPx
    },
    LOGOS: DEFAULT_THEME.logos,
    FOOTER_TEXT: DEFAULT_THEME.footerText,
    BACKGROUND_IMAGES: DEFAULT_THEME.backgroundImages
};
